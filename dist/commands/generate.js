    ...
    try {
        ...
        switch (type.toLowerCase()) {
            ...
            case 'ci':
                ...
                break;
            default:
                spinner.fail(chalk_1.default.red(`Unknown generation type: ${type}`));
                return;
        }
        if (options.dryRun) {
            spinner.succeed(chalk_1.default.green('Dry run - Generated content:'));
        ...
        const filePath = path_1.default.join(outputPath, fileName);
        await fs_extra_1.default.writeFile(filePath, content);
        spinner.succeed(chalk_1.default.green(`✨ Generated ${fileName}`));
        console.log(chalk_1.default.cyan(`📁 Location: ${filePath}`));
    }
    catch (error) {
        spinner.fail(chalk_1.default.red(`Failed to generate: ${error}`));
    }
}
...
function generateReactHook(name) {
...
function generateAPIEndpoint(name) {
